...
export const translations = {
  en: {
    ...
    hero: {
      ...
      headline1: "Your whole trip.",
      headline2: "Planned in",
      headline3: "one click.",
      sub: "Tell NativeWay where, when, your budget, and who is coming. It builds a complete itinerary: the iconic stops worth the queue, plus the local places that never make the tourist maps. Plan it with your friends in one shared lobby.",
    ...
    cta: {
      ...
      sub: "Leave your email and be the first to know the day NativeWay launches — download it before anyone else.",
      placeholder: "your@email.com",
      button: "Notify me at launch",
      success: "You're in! We'll email you the moment NativeWay launches.",
  ...
  zh: {
    ...
    hero: {
      ...
      headline2: "一键规划",
      headline3: "全部搞定。",
      sub: "告诉 NativeWay 目的地、日期、预算和同行人数，即可获得完整行程：值得排队的经典地标，以及旅游地图上找不到的本地去处。还能和朋友在同一个共享大厅里一起规划。",
      ctaPrimary: "发布时通知我",
      ctaSecondary: "了解更多",
      stat1Label: "计划城市",
      stat2Label: "已加入名单",
    ...
    cta: {
      ...
      heading1: "成为第一批",
      heading2: "以本地方式旅行",
      sub: "留下您的邮箱，第一时间获知 NativeWay 上线——抢先下载体验。",
      placeholder: "您的邮箱地址",
      button: "发布时通知我",
      success: "已加入！NativeWay 上线时我们会第一时间通知你。",
  ...
  tr: {
    ...
    hero: {
      badge: "İki dünyanın en iyisi",
      headline1: "Tüm geziniz.",
      headline2: "Tek tıkla",
      headline3: "planlanmış.",
      sub: "Nereye, ne zaman, bütçeniz ne, kimlerle — söylemeniz yeterli. NativeWay komple bir program kurar: kuyruğa değecek ikonik duraklar ve turist haritalarında çıkmayan yerel adresler. Arkadaşlarınızla ortak bir lobide birlikte planlayın.",
      ctaPrimary: "Lansmanda Haber Ver",
    ...
    cta: {
      ...
      sub: "E-postanı bırak, NativeWay yayına çıktığı an ilk sen haberdar ol — herkesten önce indir.",
      placeholder: "e-posta@adresiniz.com",
      button: "Lansmanda haber ver",
      success: "Kaydoldun! NativeWay yayına çıktığı an sana e-posta atacağız.",
    ...
    footer: {
      ...
      companyLinks: ["Hakkımızda", "İletişim"],
  ...
  no: {
    ...
    hero: {
      badge: "Det beste fra begge verdener",
      headline1: "Hele reisen din.",
      headline2: "Planlagt med",
      headline3: "ett klikk.",
      sub: "Fortell NativeWay hvor, når, budsjettet ditt og hvem som blir med. Du får en komplett reiseplan: de ikoniske stoppene som er verdt køen, pluss de lokale stedene som aldri havner på turistkartet. Planlegg sammen med vennene dine i én delt lobby.",
      ctaPrimary: "Varsle meg ved lansering",
    ...
    cta: {
      ...
      sub: "Legg igjen e-posten din og bli den første til å vite når NativeWay lanseres — last den ned før alle andre.",
      placeholder: "din@epost.no",
      button: "Varsle meg ved lansering",
      success: "Du er med! Vi sender deg en e-post idet NativeWay lanseres.",
