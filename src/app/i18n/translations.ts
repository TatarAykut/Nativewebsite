...
export const translations = {
  en: {
    ...
    about: {
      ...
      p3: "And travel is better shared. That's why NativeWay connects you with fellow travelers — plan together, swap tips, share your journey. Because the best stories aren't just the ones you experience; they're the ones you come home and tell.",
  ...
  zh: {
    ...
    about: {
      ...
      p3: "旅行的美好值得分享。NativeWay 将你与其他旅行者连接起来——一起规划、交换建议、分享旅程。因为最棒的故事，不只是你经历的那些，更是你回家后讲述的那些。",
  ...
  tr: {
    ...
    about: {
      ...
      p3: "Ve seyahat paylaşınca güzel. Bu yüzden NativeWay sizi diğer gezginlerle buluşturur — birlikte plan yapın, tavsiye alışverişinde bulunun, yolculuğunuzu paylaşın. Çünkü en iyi hikayeler sadece yaşadıklarınız değil, eve dönüp anlattıklarınızdır.",
  ...
  no: {
    ...
    about: {
      ...
      p3: "Og reise er bedre når det deles. Derfor kobler NativeWay deg med andre reisende — planlegg sammen, bytt tips, del reisen din. For de beste historiene er ikke bare de du opplever; de er de du kommer hjem og forteller.",
