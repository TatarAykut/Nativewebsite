...
export const translations = {
  en: {
    ...
    about: {
      ...
      p3: "And we never forgot that travel is better shared. NativeWay brings you together with fellow travelers — plan together, swap tips, share your journey. Because the best stories aren't just the ones you live; they're the ones you come home and tell.",
  ...
  zh: {
    ...
    about: {
      ...
      p3: "我们从未忘记，旅行因分享而更美。NativeWay 将你与其他旅行者连接起来——一起规划、交换建议、分享旅程。因为最棒的故事，不只是你经历的那些，更是你回家后讲述的那些。",
  ...
  tr: {
    ...
    about: {
      ...
      p3: "Ve seyahatin paylaştıkça güzelleştiğini hiç unutmadık. Bu yüzden NativeWay sizi diğer gezginlerle bir araya getirir; birlikte plan yapın, tavsiye alışverişinde bulunun, yolculuğunuzu paylaşın. Çünkü en iyi hikayeler sadece yaşadıklarınız değil, eve dönüp anlattıklarınızdır.",
  ...
  no: {
    ...
    about: {
      ...
      p3: "Og vi glemte aldri at reise er bedre når det deles. NativeWay bringer deg sammen med andre reisende — planlegg sammen, bytt tips, del reisen din. For de beste historiene er ikke bare de du opplever; de er de du kommer hjem og forteller.",
