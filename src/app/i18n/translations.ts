...
export const translations = {
  en: {
    ...
    about: {
      badge: "Our Story",
      heading: "Built with ambition, guided by integrity",
      p1: "NativeWay was founded by three entrepreneurs who share a conviction: travel should be extraordinary. Not just the landmarks, not just the hidden gems — the entire experience, elevated. We believe the best trips balance world-class hospitality with authentic local discovery, and that technology should make this effortless.",
      p2: "We are not a startup born from a bad meal or a hostel conversation. We are a deliberate, principles-first company. Every feature, every recommendation, every design choice reflects our commitment to quality, honesty, and the traveler's right to both comfort and authenticity.",
      founderNote: "Built by a team that values integrity over shortcuts",
      cardTitle: "",
      cardSub: "",
    },
    values: {
  ...
  zh: {
    ...
    about: {
      badge: "我们的故事",
      heading: "以雄心构建，以诚信为指引",
      p1: "NativeWay 由三位企业家创立，他们共享一个信念：旅行理应非凡。不仅仅是地标，不仅仅是隐藏的宝藏——而是整个体验的升华。我们相信最好的旅程能够平衡世界级酒店体验与真实的本地探索，而技术应当让这一切毫不费力。",
      p2: "我们不是从一顿糟糕的饭菜或一次青旅对话中诞生的创业公司。我们是一家深思熟虑、原则至上的企业。每一个功能、每一条推荐、每一个设计选择，都反映了我们对品质和诚实的承诺，以及旅行者同时拥有舒适与真实的权利。",
      founderNote: "由重视诚信胜过捷径的团队打造",
      cardTitle: "",
      cardSub: "",
    },
    values: {
  ...
  tr: {
    ...
    about: {
      badge: "Hikayemiz",
      heading: "Hırsla inşa edildi, dürüstlükle yönlendirildi",
      p1: "NativeWay, paylaştığı bir inanç etrafında birleşen üç girişimci tarafından kuruldu: seyahat olağanüstü olmalı. Sadece simge yapılar değil, sadece gizli hazineler değil — tüm deneyim, yükseltilmiş. En iyi yolculukların birinci sınıf konaklama ile otantik yerel keşfi dengelediğine ve teknolojinin bunu zahmetsiz kılması gerektiğine inanıyoruz.",
      p2: "Biz kötü bir yemekten ya da hostel sohbetinden doğan bir girişim değiliz. İlkeleri önceleyen, bilinçli bir şirketiz. Her özellik, her öneri, her tasarım tercihi; kaliteye, dürüstlüğe ve gezginin hem konfor hem otantiklik hakkına olan bağlılığımızı yansıtır.",
      founderNote: "Kısayollara değil, dürüstlüğe değer veren bir ekip tarafından inşa edildi",
      cardTitle: "",
      cardSub: "",
    },
    values: {
  ...
  no: {
    ...
    about: {
      badge: "Vår historie",
      heading: "Bygget med ambisjon, styrt av integritet",
      p1: "NativeWay ble grunnlagt av tre gründere som deler én overbevisning: reiser skal være ekstraordinære. Ikke bare landemerkene, ikke bare de skjulte perlene — hele opplevelsen, løftet. Vi tror de beste reisene balanserer førsteklasses gjestfrihet med autentisk lokal oppdagelse, og at teknologi skal gjøre dette uanstrengt.",
      p2: "Vi er ikke en startup født av et dårlig måltid eller en hostelsamtale. Vi er et bevisst, prinsippstyrt selskap. Hver funksjon, hver anbefaling, hvert designvalg gjenspeiler vårt engasjement for kvalitet, ærlighet og den reisendes rett til både komfort og autentisitet.",
      founderNote: "Bygget av et team som verdsetter integritet over snarveier",
      cardTitle: "",
      cardSub: "",
    },
    values: {
