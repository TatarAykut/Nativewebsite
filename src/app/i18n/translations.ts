...
export const translations = {
  en: {
    ...
    about: {
      ...
      p2: "NativeWay was built with one belief: the best travel guide is always a local. The 40-year-old neighborhood coffee shop, the shortcut to the viewpoint, the Sunday-only market — we learned it all from them. We combine this authentic knowledge with AI and smart planning tools to create the perfect trip.",
  ...
  zh: {
    ...
    about: {
      ...
      p2: "NativeWay 基于一个信念而诞生：最好的旅行指南永远是当地人。40年的街区咖啡馆、通往景观台的捷径、只在周日开放的市场——这一切都来自他们。我们将这份真实的知识与人工智能和智能规划工具相结合，打造完美旅程。",
  ...
  tr: {
    ...
    about: {
      ...
      p2: "NativeWay tek bir inançla kuruldu: en iyi seyahat rehberi her zaman bir yerlidir. 40 yıllık mahalle kahvesini de, manzaraya giden kestirme yolu da, sadece Pazar günleri kurulan pazarı da onlardan öğrendik. Bu otantik bilgiyi yapay zeka ve akıllı planlama araçlarımızla birleştiriyoruz.",
  ...
  no: {
    ...
    about: {
      ...
      p2: "NativeWay ble bygget på én tro: den beste reiseguiden er alltid en lokal. Den 40 år gamle kaffebaren, snarveien til utsikten, markedet som bare er åpent på søndager — vi lærte alt fra dem. Vi kombinerer denne autentiske kunnskapen med kunstig intelligens og smarte planleggingsverktøy for å skape den perfekte reisen.",
