    ...
    >
      ...
      <div className="relative max-w-2xl mx-auto px-6 text-center">
        ...
        >
          Be the first to
          <br />
          <span className="text-[#f07b22]">travel natively</span>
        </h2>
        <p className="text-[#8da3b8] text-lg leading-relaxed mb-10">
          Join thousands of travelers on our waitlist.
          Early access members get free premium for the first year.
        </p>
        ...
        {submitted ? (
          <div className="flex items-center justify-center gap-3 bg-[#122035] border border-[#f07b22]/30 rounded-2xl px-8 py-6">
            ...
            <p className="text-[#f0ece4]">You're on the list! We'll be in touch soon.</p>
          </div>
        ) : (
        ...
        <p className="text-[#8da3b8] text-xs mt-5">No spam. No commitments. Unsubscribe anytime.</p>
      </div>
    </section>
  );
}
